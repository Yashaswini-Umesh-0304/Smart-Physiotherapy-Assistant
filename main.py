...
class SmartPhysioDemoAssistant:
    def __init__(self, exercise, session_mode):
        ...
        # Audio System Initialization (gTTS/playsound)
        ...
        # Exercise Angle Thresholds - Perfect Form
        ...
        # Exercise Angle Thresholds - Standard Correct Form & Rest
        ...
        self.abd_max_angle = 170          # Upper limit for Abduction correctness
    ...
    def _get_state(self):
        ...
        return {
            ...
            "audio_lock_perfect": False,  # Locking mechanism for feedback
            "audio_lock_correct": False, 
            "frame_counter": 0,
    ...
    def _pregenerate_audio(self):
        """Pre-generate audio files for common phrases to reduce runtime latency"""
        common_phrases = [
            "Good", "Perfect",
            "Try again",
    ...
    def _audio_worker(self):
        ...
        while True:
            try:
                message = self.audio_queue.get(timeout=0.01)
                if message is None:
                    break
    ...
    def play_audio(self, message):
        ...
        try:
            # Clear queue if backing up to prevent audio lag
    ...
    def analyze_form(self, lm, ex):
        ...
        if is_in_rest_phase:
            ...
            if state["error_persistence_counter"] == 5:
                print(f"HAPTIC: Vibrate {tracked_side} - Incorrect form!")
